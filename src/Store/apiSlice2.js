...
export const fetchapi = createAsyncThunk('api/fetch', async ([item, orderby]) => {
    ...
    const res = await fetch(`https://gateway.marvel.com/v1/public/comics?titleStartsWith=${item}&orderBy=${orderby}&ts=1&apikey=db92f9d545757b399f815dd2436d7c28&hash=75393e933f7bea155893819d0cda7fa9`)
